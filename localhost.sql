...
--
-- Host: localhost
-- Generation Time: Jan 11, 2022 at 05:55 AM
...
--
CREATE DATABASE IF NOT EXISTS `presensi_gaji` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `presensi_gaji`;
...
CREATE TABLE `penggajian` (
  ...
  `bulan` char(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `pengguna` (
  ...
  `peran` enum('ADMIN','USER') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `presensi` (
  ...
  `keterangan` enum('HADIR','SAKIT','IZIN','CUTI','AKHIR PEKAN','LIBUR NASIONAL','TANPA KETERANGAN') COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
